...
public:
   ...
   */
  AutoShorterCost(const boost::property_tree::ptree& pt)
      : AutoCost(pt) {
...
public:
   ...
   * @param  pt  Property tree with configuration/options.
   */
  BusCost(const boost::property_tree::ptree& pt)
      : AutoCost(pt) {
    type_ = VehicleType::kBus;
  }
...
public:
   ...
   * @param  pt  Property tree with configuration/options.
   */
  HOVCost(const boost::property_tree::ptree& pt)
      : AutoCost(pt) {
  }
...
public:
   ...
   * @param  pt  Property tree with configuration/options.
   */
  AutoDataFix(const boost::property_tree::ptree& pt)
      : AutoCost(pt) {
  }
